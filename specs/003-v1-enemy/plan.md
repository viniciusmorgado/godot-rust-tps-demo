...
| 2 | raiz `RedRobot` (l.10584 → **10580** após o port 1: −1 do `ext_resource`, −3 dos `script`) | `CharacterBody3D` → `RedRobot` | `script = ExtResource("1")` (l.10587 → 10583); l.3 `[ext_resource type="Script" uid="uid://bf14mo0lrrvjl" path="res://enemies/red_robot/red_robot.gd" id="1"]` | `collision_layer/mask = 3`; `MultiplayerSynchronizer` (`replication_config`); `AnimationTree`; `ShootAnimation` (method tracks); `PlayerDetectionArea`; as 2 `[connection …]` (fim do arquivo) | `red_robot.gd`, `red_robot.gd.uid` |
