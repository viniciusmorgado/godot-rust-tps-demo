...
- [x] T048 [US4] Apagar `oxide-godot/main/main.gd` e `oxide-godot/main/main.gd.uid` (`git rm`); verificar `grep -rn 'uid://chrcwbh6kvb7i' oxide-godot/ | grep -v '/.godot/'` vazio e `grep -rn 'main/main.gd' oxide-godot/ --include='*.tscn' --include='*.gd'` vazio; `grep -n 'run/main_scene' oxide-godot/project.godot` = `res://main/main.tscn` (intocado)
