...
- [ ] T002 Registrar baseline do build: `cd oxide_godot_core && cargo build 2>&1 | grep -c '^warning'` → esperado `0`; anotar em `specs/004-v1-level-menu-main/quickstart.md` §"Baseline" se diferir
